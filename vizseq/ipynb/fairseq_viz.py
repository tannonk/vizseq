...
def _get_data_with_ids(log_path_or_paths: Union[str, List[str]], nbest: int = 1):
    """
    same as above _get_data function but returns ids from
    fairseq output file as well.
    """
    if isinstance(log_path_or_paths, str):
        log_path_or_paths = [log_path_or_paths]
    ids, src, ref, hypo = None, None, None, {}
